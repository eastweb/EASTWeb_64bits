...
OutputBaseFilename=EASTWebV2.2.4Installer
...
Source: "..\EASTWeb_64bits\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "postgresql-9.6.3-3-windows-x64.exe"; DestDir: "{tmp}"
Source: "jre-8u141-windows-x64.exe"; DestDir: "{tmp}"
...
; uncomment when there is actually a logo to provide
...
[Run]
Filename: "{tmp}\postgresql-9.6.3-3-windows-x64.exe"; StatusMsg: Install PostgreSQL; 
Filename: "{tmp}\jre-8u141-windows-x64.exe"; StatusMsg: Install JRE; 
