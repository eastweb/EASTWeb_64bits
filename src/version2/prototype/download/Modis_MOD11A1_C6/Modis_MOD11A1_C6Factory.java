...
public class Modis_MOD11A1_C6Factory extends DownloadFactory {
    ...
    public DownloaderFactory CreateDownloaderFactory(ListDatesFiles listDatesFiles) {
        return new ModisLocalStorageDownloadFactory(configInstance, "Modis_MOD11A1_C6Downloader", projectInfoFile, pluginInfo, downloadMetaData, pluginMetaData, scheduler, outputCache, listDatesFiles, startDate);
    }
    ...
    public ListDatesFiles CreateListDatesFiles() throws IOException {
        return new Modis_MOD11A1_C6ListDatesFiles(new DataDate(startDate), downloadMetaData, projectInfoFile);
    }
