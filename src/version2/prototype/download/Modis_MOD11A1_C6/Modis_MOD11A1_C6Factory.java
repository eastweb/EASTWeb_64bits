...
public class Modis_MOD11A1_C6Factory extends DownloadFactory {

    public Modis_MOD11A1_C6Factory(Config configInstance, ProjectInfoFile projectInfoFile, ProjectInfoPlugin pluginInfo, DownloadMetaData downloadMetaData, PluginMetaData pluginMetaData,
    ...
    public DownloaderFactory CreateDownloaderFactory(ListDatesFiles listDatesFiles) {
        return new ModisLocalStorageDownloadFactory(configInstance, "Modis_MOD11A1_C6Downloader", projectInfoFile, pluginInfo, downloadMetaData, pluginMetaData, scheduler, outputCache, listDatesFiles, startDate, endDate);
    }
    ...
    public ListDatesFiles CreateListDatesFiles() throws IOException {
        return new Modis_MOD11A1_C6ListDatesFiles(new DataDate(startDate), new DataDate(endDate), downloadMetaData, projectInfoFile);
    }
