...
public class Modis_MOD11A1_C6GlobalDownloader extends GlobalDownloader
{
    ...
    public Modis_MOD11A1_C6GlobalDownloader(int myID, Config configInstance, String pluginName, DownloadMetaData metaData, ListDatesFiles listDatesFiles, LocalDate startDate) throws ClassNotFoundException, ParserConfigurationException, SAXException,
