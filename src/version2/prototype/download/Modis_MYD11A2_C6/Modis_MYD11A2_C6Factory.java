...
public class Modis_MYD11A2_C6Factory extends DownloadFactory {

    public Modis_MYD11A2_C6Factory(Config configInstance, ProjectInfoFile projectInfoFile, ProjectInfoPlugin pluginInfo, DownloadMetaData downloadMetaData, PluginMetaData pluginMetaData,
    ...
    public DownloaderFactory CreateDownloaderFactory(ListDatesFiles listDatesFiles) {
        return new ModisLocalStorageDownloadFactory(configInstance, "Modis_MYD11A2_C6Downloader", projectInfoFile, pluginInfo, downloadMetaData, pluginMetaData, scheduler, outputCache, listDatesFiles, startDate);
    }
    ...
    public ListDatesFiles CreateListDatesFiles() throws IOException {
        return new Modis_MYD11A2_C6ListDatesFiles(new DataDate(startDate), downloadMetaData, projectInfoFile);
    }
