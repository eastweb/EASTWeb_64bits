 ...
 *
 */
public class TRMM3B42_NewGlobalDownloader extends GlobalDownloader {

    public TRMM3B42_NewGlobalDownloader(int myID, Config configInstance, String pluginName, DownloadMetaData metaData, ListDatesFiles listDatesFiles, LocalDate startDate, LocalDate endDate) throws ClassNotFoundException,
    ...
    public void run()
    {
        ...
        try {
            ...
            ErrorLog.add(Config.getInstance(), pluginName, metaData.name, "TRMM3B42RT_NewGlobalDownloader.run problem while attempting to download file.", e);
            return;
        }
        ...
        for(Map.Entry<DataDate, ArrayList<String>> entry : datesFiles.entrySet())
        {
            ...
            try {
                ...
                for (String f : entry.getValue())
                {
                    ...
                    if (f != null)
                    {
                        TRMM3B42_NewDownloader downloader = new TRMM3B42_NewDownloader(dd, outFolder, metaData, f);
                        ...
                        try {
                            ...
                            ErrorLog.add(Config.getInstance(), pluginName, metaData.name, "TRMM3B42RT_NewGlobalDownloader.run problem while attempting to add download file.", e);
                        }
                    }
                }
