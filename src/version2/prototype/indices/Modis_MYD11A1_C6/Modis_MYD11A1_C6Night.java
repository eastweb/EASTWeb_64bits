package version2.prototype.indices.Modis_MYD11A1_C6;
...
public class Modis_MYD11A1_C6Night extends IndicesFramework {
    private final int INPUT;

    public Modis_MYD11A1_C6Night(List<File> inputFiles, File outputFile, Integer noDataValue)
    {
